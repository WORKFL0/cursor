  ...
  return (
    <html lang="nl" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Workflo IT" />
        <meta name="application-name" content="Workflo IT" />
      ...
      <body className={`${inter.variable} font-sans antialiased pb-safe-bottom`}>
        ...
        >
          <LanguageProvider defaultLanguage="nl">
            <AnalyticsProvider>
              <div className="relative flex min-h-screen flex-col bg-gradient-to-br from-workflo-yellow-light/5 via-transparent to-yellow-50/10 pb-20 md:pb-0">
