...
import type { CreateCaseStudyInput, CaseStatus, ClientIndustry, ClientSize, CaseStudy } from '@/types/cases'
...
export default function EditCasePage() {
  ...
  async function loadCaseStudy() {
    try {
      ...
      const caseStudy: CaseStudy = await response.json()
      ...
      setFormData({
        ...
        client_industry: caseStudy.client_industry || 'healthcare',
        client_size: caseStudy.client_size || '10-50',
      ...
      setError('Case study kon niet worden geladen')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Case Study Bewerken</h1>
            <p className="text-muted-foreground mt-1">
              Wijzig de klant success story
            </p>
          </div>
        </div>
        <Button
