...
export default function VoIPTelefoniePage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <motion.section 
        className="relative py-20 bg-gradient-to-br from-indigo-50 via-background to-cyan-50 dark:from-indigo-950/20 dark:via-background dark:to-cyan-950/20"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                description: "Uw kantoortelefoon werkt thuis, onderweg, of in het buitenland. Dezelfde functionaliteit, overal."
              },
              {
                icon: Settings,
              ...
              },
              {
                ...
                description: "Uw mobiele telefoon wordt onderdeel van het kantoorsysteem. Één nummer, alle apparaten."
              },
              {
                icon: BarChart3,
              ...
              >
                <Card className="h-full hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg mb-4 flex items-center justify-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <Card className="border-red-200 dark:border-red-800">
                  <CardHeader>
                    <CardTitle className="text-xl text-red-600 dark:text-red-400">Traditionele Telefonie</CardTitle>
                  </CardHeader>
                  <CardContent>
              ...
              >
                <Card className="border-green-200 dark:border-green-800">
                  <CardHeader>
                    <CardTitle className="text-xl text-green-600 dark:text-green-400">Workflo VoIP</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3 text-muted-foreground">
                      {[
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-cyan-600 text-white relative overflow-hidden">
        <motion.div
