...
const diversData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '50+', label: 'Verschillende Sectoren', iconName: 'Puzzle' },
      { value: '1000+', label: 'Unieke Oplossingen', iconName: 'Settings' },
      { value: '99.7%', label: 'Klant Tevredenheid', iconName: 'Users' },
      { value: '15+', label: 'Jaar Ervaring', iconName: 'Briefcase' }
    ]
  },
