              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li>
                    <Link
                      href="/diensten"
                      className="workflo-caption text-white/70 hover:text-workflo-yellow transition-colors font-medium"
                    >
                  ...
                  <li>
                    <Link
                      href="/diensten/netwerkbeveiliging"
                      className="workflo-caption text-white/70 hover:text-workflo-yellow transition-colors"
                    >
                      Netwerkbeveiliging
                    </Link>
