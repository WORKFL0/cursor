...
export default function DangerTape({ 
  ...
  const getTapeStyle = () => {
    switch (variant) {
      ...
      case 'bold':
        return {
          background: `repeating-linear-gradient(45deg, #f59e0b 0px, #f59e0b 12px, #000000 12px, #000000 24px)`,
          height: '4px',
          opacity: 0.8
        }
      case 'warning':
        return {
          background: `repeating-linear-gradient(45deg, #fbbf24 0px, #fbbf24 15px, #dc2626 15px, #dc2626 30px)`,
          height: '6px',
          opacity: 0.9
        }
      case 'alert':
        return {
          background: `repeating-linear-gradient(45deg, #fbbf24 0px, #fbbf24 10px, #000000 10px, #000000 20px)`,
          height: '8px',
          opacity: 1
        }
      case 'background':
      ...
      default:
        return {
          background: `repeating-linear-gradient(45deg, #fbbf24 0px, #fbbf24 8px, #f3f4f6 8px, #f3f4f6 16px)`,
          height: '2px',
          opacity: 0.6
        }
    }
  ...
  if (children || text) {
    return (
      <div className={cn('relative', className)}>
        ...
        {text && (
          <div className="relative z-10 bg-yellow-400 text-black px-4 py-2 font-bold text-center uppercase tracking-wider border-2 border-black shadow-lg">
            <div 
