...
const zzpData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '25+', label: 'ZZP\'ers & Freelancers', iconName: 'User' },
      { value: '99.5%', label: 'Systeem Uptime', iconName: 'Laptop' },
      { value: '€89', label: 'Vanaf per maand', iconName: 'Calculator' },
      { value: '24/7', label: 'Online Support', iconName: 'Smartphone' }
    ]
  },
