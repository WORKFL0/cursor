...
const nonProfitData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '180+', label: 'Non-Profit Klanten', iconName: 'Heart' },
      { value: '50%', label: 'Korting op tarieven', iconName: 'DollarSign' },
      { value: '99.8%', label: 'Donor Database Uptime', iconName: 'Shield' },
      { value: '10K+', label: 'Vrijwilligers Ondersteund', iconName: 'Users' }
    ]
  },
