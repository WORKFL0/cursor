          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              },
              {
                ...
                description: "Team groeit? Je moet opnieuw investeren. Team krimpt? Je zit vast aan overtollige hardware.",
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="h-full hover:shadow-lg transition-shadow border-primary/20 dark:border-primary">
                  <CardContent className="p-6">
                    <h3 className="font-bold mb-3 text-primary dark:text-primary">{problem.title}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <Card className="border-destructive/20 dark:border-destructive">
                  <CardHeader>
                    <CardTitle className="text-xl text-destructive dark:text-destructive">Hardware Kopen (10 laptops)</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="border-t pt-3 flex justify-between">
                        ...
                        <span className="font-bold text-destructive dark:text-destructive">€58.000</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              >
                <Card className="border-primary/20 dark:border-primary">
                  <CardHeader>
                    <CardTitle className="text-xl text-primary dark:text-primary">Workflo HaaS (10 laptops)</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between">
                      ...
                      <div className="border-t pt-3 flex justify-between">
                        <span className="font-bold">Totale kosten 3 jaar:</span>
                        <span className="font-bold text-primary dark:text-primary">€39.600</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center">
                    <Laptop className="h-6 w-6 text-primary dark:text-primary" />
                  </div>
                  <div>
