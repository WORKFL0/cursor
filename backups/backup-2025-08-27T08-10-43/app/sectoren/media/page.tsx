...
import { Video, Broadcast, Camera, HardDrive, Cloud, Wifi, Monitor, CheckCircle } from 'lucide-react'
...
const mediaData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '75+', label: 'Media Bedrijven', icon: Video },
      { value: '1PB+', label: 'Media Opslag', icon: HardDrive },
      { value: '99.9%', label: 'Streaming Uptime', icon: Broadcast },
      { value: '24/7', label: 'Productie Support', icon: Monitor }
    ]
  },
