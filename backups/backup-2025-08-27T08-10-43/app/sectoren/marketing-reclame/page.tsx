...
import { Megaphone, Target, BarChart, Palette, Cloud, Users, Monitor, CheckCircle } from 'lucide-react'
...
const marketingReclameData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '200+', label: 'Marketing Agencies', icon: Megaphone },
      { value: '99.8%', label: 'Campaign Uptime', icon: Target },
      { value: '50TB+', label: 'Creative Assets', icon: Palette },
      { value: '24/7', label: 'Support Beschikbaar', icon: Users }
    ]
  },
