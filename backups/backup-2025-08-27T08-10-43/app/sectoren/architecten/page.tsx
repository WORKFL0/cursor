...
import { Building2, Ruler, Palette, Layers, Cloud, Shield, Users, CheckCircle } from 'lucide-react'
...
const architectenData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '50+', label: 'Architectenbureaus', icon: Building2 },
      { value: '99.9%', label: 'Uptime CAD-systemen', icon: Layers },
      { value: '10TB+', label: 'Project Storage', icon: Cloud },
