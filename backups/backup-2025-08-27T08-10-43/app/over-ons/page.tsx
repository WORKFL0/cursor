...
export default function AboutPage() {
  ...
  const whyChooseData = [
    {
      icon: Shield,
      titleNL: 'Betrouwbare Partner sinds 2015',
      title: 'Trusted Partner since 2015',
      descriptionNL: 'Al 10+ jaar dé IT-partner voor Amsterdam. Bewezen track record met 250+ tevreden klanten.',
      description: '10+ years as Amsterdam\'s IT partner. Proven track record with 250+ satisfied clients.'
    },
    {
      icon: Star,
  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="description" 
          content="Leer Workflo kennen: Amsterdam's meest vertrouwde IT-partner sinds 2015. Ontmoet ons team van experts en ontdek waarom 250+ bedrijven hun IT aan ons toevertrouwen."
        />
        <meta 
          name="keywords" 
        ...
        <meta property="og:description" content="Ontdek waarom 250+ bedrijven hun IT aan Workflo toevertrouwen. Leer ons team kennen en onze reis van startup tot Amsterdam's meest vertrouwde IT-partner." />
        ...
        <meta name="twitter:description" content="Ontmoet het team achter 250+ tevreden klanten. Van startup tot vertrouwde IT-partner in Amsterdam." />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <motion.p variants={fadeInUp} className="text-xl text-muted-foreground max-w-3xl mx-auto">
                {language === 'nl' 
                  ? 'Ontdek waarom 250+ bedrijven in Amsterdam en omgeving hun IT aan ons toevertrouwen'
                  : 'Discover why 250+ businesses in Amsterdam and surroundings trust us with their IT'
                }
              </motion.p>
            </motion.div>
                    ...
                    <CardHeader>
                      <div className="relative w-32 h-32 mx-auto mb-4 group-hover:scale-105 transition-transform duration-300">
                        <Image
                          ...
                          alt={member.name}
                          fill
                          className="rounded-full object-cover border-4 border-workflo-yellow/20 group-hover:border-workflo-yellow/40 transition-colors duration-300"
                        />
                      </div>
                      <CardTitle className="text-xl font-bold text-foreground">
                        {member.name}
                      </CardTitle>
                      <p className="text-workflo-yellow-dark font-semibold">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-wrap gap-1 justify-center">
                          {(language === 'nl' ? member.specialtiesNL : member.specialties).map((specialty, i) => (
                            <span 
                              key={i} 
                              className="inline-block bg-workflo-yellow/10 text-workflo-yellow-dark text-xs px-2 py-1 rounded-full border border-workflo-yellow/20"
                            >
                              {specialty}
                            </span>
                          ))}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <motion.p variants={fadeInUp} className="text-xl text-muted-foreground max-w-2xl mx-auto">
                {language === 'nl' 
                  ? 'Erkend door de beste in de branche. Onze certificeringen garanderen expertise en kwaliteit.'
                  : 'Recognized by the best in the industry. Our certifications guarantee expertise and quality.'
                }
              </motion.p>
            </motion.div>
            ...
            >
              {companyInfo.certifications.map((cert, index) => (
                <motion.div key={index} variants={scaleIn}>
                  <Card className="bg-card shadow-lg border border-border hover:border-workflo-yellow/50 hover:shadow-xl text-center p-6 transition-all duration-300 group h-full">
                    <Award className="w-8 h-8 text-workflo-yellow-dark mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                    <div className="text-lg font-semibold text-foreground group-hover:text-workflo-yellow-dark transition-colors duration-300">
                      {cert}
                    </div>
                  </Card>
                </motion.div>
            ...
            <motion.div 
              ...
              variants={staggerContainer}
            >
              <motion.h3 variants={fadeInUp} className="text-2xl lg:text-3xl font-bold text-foreground mb-8 text-center">
              ...
              >
                {companyInfo.partnerships.map((partner, index) => (
                  <motion.div key={index} variants={scaleIn}>
                    <Card className="bg-card shadow-lg border border-border hover:border-workflo-yellow/50 hover:shadow-xl text-center p-6 transition-all duration-300 group h-full">
                      <Building2 className="w-8 h-8 text-workflo-yellow-dark mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" />
                      <div className="text-lg font-semibold text-foreground group-hover:text-workflo-yellow-dark transition-colors duration-300">
                        {partner}
                      </div>
                    </Card>
