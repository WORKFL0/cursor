...
const financieleSectorData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '30+', label: 'Financiële Klanten', iconName: 'Building' },
      { value: '100%', label: 'DNB Compliant', iconName: 'FileCheck' },
      { value: 'ISO 27001', label: 'Gecertificeerd', iconName: 'Shield' },
      { value: '24/7', label: 'Security Monitoring', iconName: 'Clock' }
    ]
  },
