...
const retailData: SectorPageData = {
  hero: {
    ...
    stats: [
      { value: '350+', label: 'Retail Klanten', iconName: 'Store' },
      { value: '99.9%', label: 'POS Uptime', iconName: 'CreditCard' },
      { value: '1M+', label: 'Transacties/dag', iconName: 'ShoppingCart' },
      { value: '<5s', label: 'Checkout Tijd', iconName: 'Package' }
    ]
  },
