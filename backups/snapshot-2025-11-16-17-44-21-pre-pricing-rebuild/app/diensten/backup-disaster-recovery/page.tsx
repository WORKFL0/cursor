          ...
          >
            ...
            >
              <Alert className="border-primary bg-primary/10 dark:border-primary dark:bg-primary/20 max-w-3xl mx-auto">
                <AlertTriangle className="h-5 w-5 text-primary dark:text-primary" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="text-center hover:shadow-lg transition-shadow border-primary/20 dark:border-primary">
                  <CardContent className="p-6">
                    <div className="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-lg mx-auto mb-4 flex items-center justify-center">
                      <problem.icon className="h-6 w-6 text-primary dark:text-primary" />
                    </div>
                ...
                <Card className="h-full hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="w-12 h-12 bg-primary/10 dark:bg-primary/20 rounded-lg mb-4 flex items-center justify-center">
                      <solution.icon className="h-6 w-6 text-primary dark:text-primary" />
                    </div>
              ...
              >
                <Card className="text-center hover:shadow-lg transition-shadow border-primary/20 dark:border-primary">
                  <CardContent className="p-8">
                    <div className="text-4xl font-bold text-primary dark:text-primary mb-2">{guarantee.time}</div>
            ...
            <Card className="border-primary/20 dark:border-primary">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  Met onze incremental backup technologie garanderen we dat je nooit meer dan 
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <Card className="border-destructive/20 dark:border-destructive">
                  <CardHeader>
                    <CardTitle className="text-xl text-destructive dark:text-destructive">Kosten van Dataverlies</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3 text-muted-foreground">
                      ...
                      <li className="flex justify-between border-t pt-3">
                        ...
                        <span className="font-bold text-destructive dark:text-destructive">€110.000 - €20.650.000</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
              ...
              >
                <Card className="border-primary/20 dark:border-primary">
                  <CardHeader>
                    <CardTitle className="text-xl text-primary dark:text-primary">Workflo Backup & DR</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-3 text-muted-foreground">
                      <li className="flex justify-between">
                      ...
                      <li className="flex justify-between">
                        ...
                        <span className="font-semibold text-primary dark:text-primary">Onbetaalbaar</span>
                      </li>
                      <li className="flex justify-between border-t pt-3">
                        <span className="font-bold">Jaarlijkse kosten:</span>
                        <span className="font-bold text-primary dark:text-primary">€1.800 - €6.000</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
            ...
            >
              <Card className="inline-block bg-gradient-to-r from-primary/10 to-transparent">
                <CardContent className="p-6">
