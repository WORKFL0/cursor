        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/diensten/cloud" className="text-neutral-700 dark:text-neutral-300 hover:text-primary transition-colors">
                  Cloud
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/diensten/it-helpdesk" className="text-neutral-700 dark:text-neutral-300 hover:text-primary transition-colors">
                  IT-helpdesk
                </Link>
              </li>
              <li>
                <Link href="/diensten/backup-herstel" className="text-neutral-700 dark:text-neutral-300 hover:text-primary transition-colors">
                  Backup & herstel
                </Link>
              </li>
              <li>
                <Link href="/diensten/netwerkbeveiliging" className="text-neutral-700 dark:text-neutral-300 hover:text-primary transition-colors">
                  Netwerkbeveiliging
                </Link>
              </li>
            </ul>
