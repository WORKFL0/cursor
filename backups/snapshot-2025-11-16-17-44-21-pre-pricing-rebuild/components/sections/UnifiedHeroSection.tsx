  ...
  return (
    <section
      ...
      className={`relative min-h-screen flex items-center overflow-hidden ${
        isPremium
          ? 'justify-center bg-gradient-to-br from-background via-neutral-50 to-primary-muted/20 pt-32 pb-24'
          : 'bg-gradient-to-br from-background to-muted/30 pt-32 pb-24'
      }`}
    >
      {renderBackground()}
      ...
      <div className={containerClass}>
        <div className={gridClass}>
          ...
          >
            ...
            <motion.h1
              className={isPremium
                ? "text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold mb-8 leading-[1.05] tracking-tighter text-balance"
                : "text-5xl lg:text-6xl font-bold tracking-tighter text-neutral-900 dark:text-neutral-50 mb-6 leading-tight"
              }
              style={{ fontSize: isPremium ? 'clamp(3.5rem, 6vw, 5rem)' : undefined }}
              initial={{ opacity: 0, y: 20 }}
              animate={{
                opacity: isPremium ? (isInView ? 1 : 0) : 1,
                y: isPremium ? (isInView ? 0 : 20) : 0
            ...
            <motion.p
              className={isPremium
                ? "text-xl sm:text-2xl lg:text-3xl text-neutral-700 dark:text-neutral-300 mb-12 leading-relaxed max-w-3xl text-balance font-medium"
                : "text-xl text-neutral-700 dark:text-neutral-300 mb-12 leading-relaxed"
              }
              initial={{ opacity: 0, y: 20 }}
              animate={{
                opacity: isPremium ? (isInView ? 1 : 0) : 1,
            ...
            {/* CTA Buttons */}
            <motion.div
              className={isPremium ? "flex flex-col sm:flex-row gap-4 mb-16" : "flex flex-col sm:flex-row gap-4 mb-12"}
              initial={{ opacity: 0, y: 20 }}
              animate={{
                opacity: isPremium ? (isInView ? 1 : 0) : 1,
                y: isPremium ? (isInView ? 0 : 20) : 0
            ...
            >
              <Button
                ...
                variant="workflo"
                className={isPremium
                  ? "shadow-xl hover:shadow-2xl group px-10 py-7 text-lg font-bold tracking-tight transition-all duration-200 ease-out hover:scale-105"
                  : "min-h-14 px-10 text-lg font-bold tracking-tight shadow-lg hover:shadow-xl transition-all duration-200 ease-out"
                }
              >
